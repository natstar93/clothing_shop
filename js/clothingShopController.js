clothingShop.controller('ClothingShopProductsController', [function() {
  this.products = [
    ...
    { 'name': 'Fine Stripe Short Sleeve Shirt, Grey', 'category': 'Men\'s Footwear', 'price': 49.99, quantity: 9 },
    { 'name': 'Fine Stripe Short Sleeve Shirt, Green', 'category': 'Men\'s Footwear', 'price': 39.99, quantity: 3 },
